...
public class ReaHttpCommandExecutor implements CommandExecutor {
    ...
    public ReaHttpCommandExecutor(URL addressOfRemoteServer) {
        try {
        ...
        nameToUrl = ImmutableMap.<String, CommandInfo>builder()
                ...
                .put(ReaNativeCommand.IS_DISPLAYED, post("/session/:sessionId/element/:id/isDisplayed"))
